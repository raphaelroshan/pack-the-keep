...
func _initialize() -> void:
	...
	_check(panel.visible and panel.title_label.text == "AUTHORED EVENT — Test Event | RECOVERY", "extracted panel should preserve event heading rendering")
	_check(not panel.choice_buttons[0].disabled and panel.choice_buttons[1].disabled and panel.choice_details[1].text.contains("BLOCKED — needs materials"), "extracted panel should preserve legal and blocked choice states")
