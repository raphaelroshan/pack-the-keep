...
def complete_report(profile_dir: Path, version: str, phase: str, executable: Path) -> dict[str, object]:
    report: dict[str, object] = {
        ...
        "content_status": {"ok": True, "keep_count": 2, "region_count": 1, "commander_count": 2, "piece_count": 17, "pack_count": 9, "enemy_count": 8, "doctrine_count": 9, "scenario_count": 11, "event_count": 9, "modifier_count": 2},
