...
def complete_report(profile_dir: Path, version: str, phase: str, executable: Path) -> dict[str, object]:
    report: dict[str, object] = {
        ...
        "content_status": {"ok": True, "keep_count": 3, "region_count": 1, "commander_count": 3, "piece_count": 19, "pack_count": 10, "enemy_count": 9, "doctrine_count": 10, "scenario_count": 13, "event_count": 9, "modifier_count": 2},
