...
func _initialize() -> void:
	...
	_check(selection_text.contains("SCENARIO 10/10") and selection_text.contains("The Last Bell"), "scenario briefing should expose catalogue position and title")
	...
	_check(ui._selected_id(ui.scenario_option) == "ash_ford_crossing", "previous scenario should move backward through the authored catalogue")
	ui._cycle_scenario(1)
