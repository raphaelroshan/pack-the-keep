...
func run(ui: Control) -> void:
	...
	var expected_counts: Dictionary = {"commander_count": 2, "piece_count": 17, "pack_count": 9, "enemy_count": 7, "doctrine_count": 8, "scenario_count": 8, "event_count": 7, "modifier_count": 2}
