...
func run(ui: Control) -> void:
	...
	var expected_counts: Dictionary = {"keep_count": 2, "region_count": 1, "commander_count": 2, "piece_count": 17, "pack_count": 9, "enemy_count": 7, "doctrine_count": 8, "scenario_count": 10, "event_count": 9, "modifier_count": 2}
