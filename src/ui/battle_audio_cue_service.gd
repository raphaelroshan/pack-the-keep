...
const SAMPLE_SOURCE := "Kenney Interface Sounds / RPG Audio · CC0"

const CUE_PROFILES := {
	"warning": {"frequencies": [330.0, 440.0], "duration": 0.055, "gain": 0.9, "sample_gain": 0.72, "sample_path": "res://assets/temporary/kenney/interface-sounds/Audio/bong_001.ogg", "beat": "assault_start"},
	"contact": {"frequencies": [160.0], "duration": 0.085, "gain": 1.0, "sample_gain": 0.82, "sample_path": "res://assets/temporary/kenney/rpg-audio/Audio/footstep04.ogg", "beat": "contact"},
	"volley": {"frequencies": [610.0, 780.0], "duration": 0.04, "gain": 0.7, "sample_gain": 0.68, "sample_path": "res://assets/temporary/kenney/rpg-audio/Audio/knifeSlice2.ogg", "beat": "defender_response"},
	"impact": {"frequencies": [135.0, 190.0], "duration": 0.065, "gain": 0.9, "sample_gain": 0.82, "sample_path": "res://assets/temporary/kenney/rpg-audio/Audio/chop.ogg", "beat": "hostile_impact"},
	"breach": {"frequencies": [280.0, 205.0, 145.0], "duration": 0.07, "gain": 0.95, "sample_gain": 0.88, "sample_path": "res://assets/temporary/kenney/rpg-audio/Audio/doorClose_3.ogg", "beat": "breach"},
	"confirm": {"frequencies": [480.0], "duration": 0.07, "gain": 0.75, "sample_gain": 0.65, "sample_path": "res://assets/temporary/kenney/interface-sounds/Audio/confirmation_002.ogg", "beat": "confirm"},
	"repair": {"frequencies": [390.0, 520.0], "duration": 0.06, "gain": 0.8, "sample_gain": 0.64, "sample_path": "res://assets/temporary/kenney/rpg-audio/Audio/metalClick.ogg", "beat": "recovery"},
	"ability": {"frequencies": [520.0, 660.0], "duration": 0.065, "gain": 0.9, "sample_gain": 0.72, "sample_path": "res://assets/temporary/kenney/rpg-audio/Audio/drawKnife1.ogg", "beat": "ability"},
	"error": {"frequencies": [140.0], "duration": 0.1, "gain": 1.0, "sample_gain": 0.7, "sample_path": "res://assets/temporary/kenney/interface-sounds/Audio/error_003.ogg", "beat": "error"},
	"pause": {"frequencies": [300.0], "duration": 0.055, "gain": 0.65, "sample_gain": 0.52, "sample_path": "res://assets/temporary/kenney/interface-sounds/Audio/switch_001.ogg", "beat": "pause"},
	"resume": {"frequencies": [500.0], "duration": 0.055, "gain": 0.65, "sample_gain": 0.52, "sample_path": "res://assets/temporary/kenney/interface-sounds/Audio/switch_003.ogg", "beat": "resume"},
	"hold": {"frequencies": [520.0, 660.0, 780.0], "duration": 0.055, "gain": 0.85, "sample_gain": 0.72, "sample_path": "res://assets/temporary/kenney/interface-sounds/Audio/confirmation_004.ogg", "beat": "terminal_hold"},
	"partial_breach": {"frequencies": [360.0, 250.0], "duration": 0.075, "gain": 0.9, "sample_gain": 0.7, "sample_path": "res://assets/temporary/kenney/interface-sounds/Audio/error_005.ogg", "beat": "terminal_partial_breach"},
	"collapse": {"frequencies": [220.0, 150.0], "duration": 0.09, "gain": 1.0, "sample_gain": 0.9, "sample_path": "res://assets/temporary/kenney/rpg-audio/Audio/doorClose_4.ogg", "beat": "terminal_collapse"}
}
