...
const STEPS: Array[Dictionary] = [
	...
	{"id": "inspect_pike", "screen": "preparation", "speaker": "THE CASTELLAN", "title": "Read Unit Behaviour", "body": "Every defender card names its role, health, attack style, valid targets, assignment, and positioning question. Select Pike Squad on the fort.", "objective": "Inspect Pike Squad.", "action": "inspect_piece:pike_squad", "focus": "board_pike"},
	...
	{"id": "observe_first", "screen": "battle", "speaker": "THE CASTELLAN", "title": "Hold the Gate", "body": "Pause whenever you need to inspect. The lesson advances when the authoritative assault resolves.", "objective": "Complete assault phase one.", "action": "observe_wave", "focus": "fort"},
	...
	{"id": "assign_gate", "screen": "results", "speaker": "THE CASTELLAN", "title": "Give the Squad a Duty", "body": "Assignments commit specialists to a room until a later recovery. Pike Squad assigned to Gate gains its authored hold bonus.", "objective": "Assign Pike Squad to Gate.", "action": "assign_piece:gate", "focus": "assign_piece"},
	...
	{"id": "resume_second", "screen": "battle", "speaker": "THE CASTELLAN", "title": "Two Pressures", "body": "One enemy clears defenders while the other attacks the keep’s function. A strong line does not remove the need for recovery.", "objective": "Resume assault phase two.", "action": "resume_battle", "focus": "primary_action"},
