...
The automated matrix covers all fourteen non-overwhelming scenarios, all three commanders, and seeds `3307`, `3308`, and `3309`: 126 cases. Every case is executed once continuously and once with a save/load checkpoint, for 252 total deterministic simulations.
