...
The automated matrix covers all thirteen non-overwhelming scenarios, all three commanders, and seeds `3307`, `3308`, and `3309`: 117 cases. Every case is executed once continuously and once with a save/load checkpoint, for 234 total deterministic simulations.
