...
Read [`docs/qa_playbook.md`](docs/qa_playbook.md), [`docs/agent_qa_decision.md`](docs/agent_qa_decision.md), and [`AGENTS.md`](AGENTS.md) before implementation. Run [`scripts/agent_qa.sh`](scripts/agent_qa.sh) to produce a result and evidence bundle. The first semantic journey contract is [`qa/scenarios/pack_greywatch_three_wave.json`](qa/scenarios/pack_greywatch_three_wave.json).
