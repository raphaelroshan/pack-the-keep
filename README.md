...
The optional width, height, and UI-scale index (`0`–`4` for 80%–200%) make responsive comparisons repeatable. The harness writes nine ordered PNGs plus `capture-manifest.json`. It is automated visual evidence, not a human playtest result.
