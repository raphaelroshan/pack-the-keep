...
| Authored audio mix | Hear each original semantic cue at multiple volume presets; verify differentiation, balance, mute, restore, and no clipping or stuck playback. | Pending |
| Forced-close recovery | Automation kills one prepared packaged process and proves backup recovery. Manually vary termination timing during active play and around real save operations; confirm recovery and unchanged current state after invalid candidates. | Pending |
