...
**Current development baseline:** `0.31.0-quartermaster`; P51.1 adds the Quartermaster reserve-economy lens on top of the completed K8 and P54 gates; optional human private-alpha evidence and owner distribution approval remain pending
...
| P51 | In progress: commander lens implemented | The Quartermaster trades the weakest opening reserve for a visible first-pack discount, stronger surviving Supply Cache, and bounded once-per-assault Resupply. | Add one isolated defensive identity next; do not combine new questions yet. |
