...
**Current release baseline:** `0.16.1-playtest-triage` on PR #26; remote `main` remains owner-controlled
...
| P16 | Readiness and triage implemented; sessions pending | Controlled alpha protocol, reproducible build identity, evidence schema, validation, and repeated-finding summaries are in place. | Run the four human-observed matrix sessions, implement repeated friction tasks, and require explicit owner approval before release preparation. |
