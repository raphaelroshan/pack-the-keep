...
| P48 | Next: responsive layout repair | Make War Council, Preparation, Battle, Recovery, and Results robust at 1280×720, 1600×900, high text scale, and controller focus. | No required action, subject, or consequence may clip. |
| P49 | Next: authored visual finish | Replace the highest-noise procedural surfaces with coherent tactile 2D fortress treatments while preserving geometry and state colors. | Capture before/after evidence at normal and scaled layouts. |
