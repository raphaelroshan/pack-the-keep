...
**Current development baseline:** `0.65.0-preparation-first-viewport`; PTK-GPT56-1 through PTK-GPT56-5 plus PTK-GPT56-1B are machine-checked, all twelve commander/keep pairings expose their geometry fit, Preparation keeps its compact decision rail beside the fortress at 1280×720, Assault, Recovery, and terminal Results remain board-first, normal player guidance is protected from development vocabulary, every major phase has save/resume evidence, and all prior investment, Early Access, presentation, accessibility, and package gates remain enforced; optional human evidence and owner distribution approval remain pending
