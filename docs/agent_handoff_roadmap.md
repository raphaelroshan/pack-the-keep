...
**Document status:** Early Access roadmap implemented through PTK-EA-6 automated candidate hardening
**Current development baseline:** `0.51.0-early-access-candidate`; Greywatch, Ash Ford, and Twinwatch now meet the keep contract, the fourth Marshal lens and approved content floors are active, and accessibility, persistence, replay, performance, visual evidence, and package gates are enforced together; optional human evidence and owner distribution approval remain pending
