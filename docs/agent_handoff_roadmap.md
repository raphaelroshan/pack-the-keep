...
**Document status:** Active planning contract for post-v0.13.4 development
**Current release baseline:** `0.13.4-old-drain-occurrence` on PR #26; remote `main` remains `0.12.3-alpha-packaged-pause-close`
