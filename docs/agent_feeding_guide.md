...
> Current baseline override for the compact prompt below: `0.25.4-playtest-release-kit`, including the P44 Battle presentation snapshot, P45 debug-only layout auditing, P46 confirmed unsaved-run navigation, and P47 self-contained tagged playtest cohorts.
