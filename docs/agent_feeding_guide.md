...
> Current baseline override for the compact prompt below: `0.24.1-battle-command-hierarchy`, including the P40 three-stage Preparation hierarchy, P41 unified tactical inspector, and P42 Battle command hierarchy.
