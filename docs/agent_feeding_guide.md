...
> Current baseline override for the compact prompt below: `0.25.2-presentation-audit`, including P43 local-only observation/capture tooling, the P44 Battle presentation snapshot boundary, and P45 debug-only layout auditing.
