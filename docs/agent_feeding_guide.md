...
> Current baseline override for the compact prompt below: `0.25.1-battle-presentation-snapshot`, including the P42 Battle command hierarchy, P43 local-only observation/capture tooling, and P44 Battle presentation snapshot boundary.
