...
> Current baseline override for the compact prompt below: `0.25.0-local-playtest-observer`, including the P41 unified tactical inspector, P42 Battle command hierarchy, and P43 local-only observation/capture tooling.
