...
> Current baseline override for the compact prompt below: `0.25.3-navigation-safety`, including the P44 Battle presentation snapshot, P45 debug-only layout auditing, and P46 confirmed unsaved-run navigation.
