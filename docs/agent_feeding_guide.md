...
> Current baseline override for the compact prompt below: `0.23.2-preparation-hierarchy`, including the P39 pack offer card and P40 three-stage Preparation command hierarchy.
