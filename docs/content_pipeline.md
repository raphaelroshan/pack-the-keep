...
| `tools/validate_runtime_content.py` | Validator for runtime commander, piece, pack, enemy, doctrine, scenario, and event schemas, stable filenames/IDs, references, typed operations, and manifest parity. |
