...
| `tools/validate_runtime_content.py` | Validator for runtime commander, piece, pack, enemy, doctrine, scenario, event, and modifier schemas, stable filenames/IDs, references, typed operations, and manifest parity. |
