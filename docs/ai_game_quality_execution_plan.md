...
**Applies to:** `v0.63.0-board-first-results` and later
...
> The automated GPT56, investment, and Early Access roadmaps are complete at `0.63.0-board-first-results`. Preserve PTK-GPT56-1 through PTK-GPT56-5, PTK-I1 through PTK-I6, PTK-EA-1 through PTK-EA-6, P67–P75, K1–K8, P51–P66, P54, responsive-decision, room-label, authored-actor, authored-room, authored-audio, combat-effect, and repair-feedback gates. The Kenney kit is archived and no active presentation profile references it. Do not invent human findings or distribution approval.
