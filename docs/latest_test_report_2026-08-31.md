...
| Field | Result |
| --- | --- |
| Build | `0.36.0-twilight-crossroads` |
...
| Performance budget | PASS: 40 runs in 4003 ms; 120 large-text UI refreshes in 245 ms |
| P51/P52 focused tests | PASS: all P51 content plus 18 mixed-plan Twilight Crossroads runs, active-event save/load parity, one-shot route effects, player-facing event hierarchy, controller focus, and responsive layout |
