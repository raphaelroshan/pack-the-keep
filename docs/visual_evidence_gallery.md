...
![Pack the Keep title](visual_evidence/v0.20.0-first-watch/01_title.png)

The title presents the commander-and-pack premise and the entry into the First Watch experience.

### Preparation

![Pack the Keep preparation](visual_evidence/v0.20.0-first-watch/02_preparation.png)
...
![Pack the Keep wave 1 paused](visual_evidence/v0.20.0-first-watch/03_wave1_paused.png)
...
![Pack the Keep inter-wave results](visual_evidence/v0.20.0-first-watch/04_interwave_results.png)

The first inter-wave report shows damage, recovery, and the consequences carried into the next assault.

### Wave 2 paused

![Pack the Keep wave 2 paused](visual_evidence/v0.20.0-first-watch/05_wave2_paused.png)
...
![Pack the Keep second inter-wave results](visual_evidence/v0.20.0-first-watch/06_interwave2_results.png)

The second report provides a useful development snapshot for showing how the game explains escalation and recovery.

### Wave 3 paused

![Pack the Keep wave 3 paused](visual_evidence/v0.20.0-first-watch/07_wave3_paused.png)
...
![Pack the Keep final results](visual_evidence/v0.20.0-first-watch/08_final_results.png)
