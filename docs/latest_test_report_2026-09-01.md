...
| Field | Result |
| --- | --- |
| Build | `0.58.0-recovery-action-order` |
...
| Performance budget | PASS: 40 runs in 2293 ms; 120 large-text UI refreshes in 249 ms |
...
| P71 Recovery action order | PASS: legal recovery cards stably precede blocked diagnostics, retain authored relative order, and keep Finish Recovery as the final command without changing costs or outcomes |
