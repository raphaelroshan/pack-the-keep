...
P59 adds one compact prop silhouette to each of Greywatch's seven functional rooms. The gate, armory, workshop, barracks, supply room, tower, and chapel gain distinct spatial memory cues while the inner yard and outer wall remain open. Preparation and Battle captures retain readable labels, health bars, unit cards, target lines, and selection hierarchy; the props are visibly secondary and intentionally temporary.
