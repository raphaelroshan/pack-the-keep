...
**Current baseline:** `0.37.0-seeded-pressure`
**Current status:** P51 controlled content and P52 replayable mastery are complete on an engineering-complete pre-alpha foundation; P53 hardening review and human validation remain pending
