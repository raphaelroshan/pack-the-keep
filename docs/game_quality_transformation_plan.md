...
**Current baseline:** `0.51.0-early-access-candidate`
**Current status:** PTK-EA-1 through PTK-EA-6 are implemented: all three keeps meet the scenario contract, the Marshal completes the commander roster, content reaches the approved breadth floor, and candidate hardening remains enforced. Human validation and owner distribution approval remain pending.
