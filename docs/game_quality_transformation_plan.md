...
**Current baseline:** `0.31.0-quartermaster`
...
| Content breadth | Eleven scenarios, nine packs, three commanders, multiple defenders/enemies, authored events, event history, Mara arc, rare occurrence, and a regional consequence. |
