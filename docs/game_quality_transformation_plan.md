...
**Current baseline:** `0.30.1-forced-close-recovery`
...
| Content breadth | Eight scenarios, nine packs, two commanders, multiple defenders/enemies, authored events, event history, Mara arc, rare occurrence, and a regional consequence. |
