...
**Current baseline:** `0.61.0-battle-first-assault`
**Current status:** PTK-GPT56-1 through PTK-GPT56-5, PTK-I1 through PTK-I6, and PTK-EA-1 through PTK-EA-6 are implemented. All three keeps expose distinct plans and a complete commander-to-geometry matrix, and Preparation plus Assault are board-first at 1280×720. Human validation and owner distribution approval remain pending.
