...
**Current baseline:** `0.64.0-player-facing-language`
**Current status:** PTK-GPT56-1 through PTK-GPT56-5, PTK-I1 through PTK-I6, and PTK-EA-1 through PTK-EA-6 are implemented. All three keeps expose distinct plans and a complete commander-to-geometry matrix, every major tactical phase is board-first at 1280×720, and normal player guidance uses direct in-world language. Human validation and owner distribution approval remain pending.
...
**Implementation ledger:** P51.1 adds the Quartermaster reserve-economy commander lens. P51.2 adds Twinwatch Bastion's paired-post spatial rule and ridge visual identity. P51.3 adds Road Wardens versus Outriders as a prepared-delay teaching pair. P51.4 adds Lantern Watch versus Gloam Knives as a route-visibility teaching pair. P51.5 adds The Twilight Road, which teaches those questions separately and together. P52 adds a one-action route preparation, branch-aware terminal mastery, and disclosed deterministic final pressure. P53 composes the complete player journey under 2560×1440 large text, high contrast, reduced motion, muted semantic cues, controller focus, save boundaries, responsive Results, and package/failure-recovery gates. P55–P65 establish and then replace temporary actor, room, and effect assets with original small-scale presentation. P66 replaces the final active borrowed family with fourteen reproducible original semantic WAV cues while preserving the existing four-player pool and generated-tone fallback. P67–P75 keep plan selection, navigation, phase framing, tactical board labels, War Council disclosure, Recovery action hierarchy, and board-first Preparation/Assault/Recovery/Results coherent without changing simulation authority. P76 removes roadmap and test-harness language from scenario cards, events, tutorials, battle feedback, and shared UI while preserving every mechanical value and ID. PTK-I1 through PTK-I6 bind the complete investment vertical to distinct keep-owned first plans, all-phase persistence, cross-keep consequence continuation, dual-resolution evidence, and a machine-readable ledger. P32–P49, K3–K8, P54, and PTK-EA-1 through PTK-EA-6 remain enforced regression contracts. The automated roadmap is complete; human validation remains pending.
...
The Greywatch PTK-EA-1 anchor plus the automated K1–K8 and P51–P66 transformation roadmap are complete. Preserve their gates and
