...
**Current baseline:** `0.38.0-alpha-hardened`
**Current status:** P51 controlled content, P52 replayable mastery, and the automated P53 alpha-flow hardening review are complete; human validation remains pending
