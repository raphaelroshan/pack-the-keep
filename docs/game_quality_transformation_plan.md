...
**Current baseline:** `0.60.0-board-first-preparation`
**Current status:** PTK-GPT56-1 through PTK-GPT56-5, PTK-I1 through PTK-I6, and PTK-EA-1 through PTK-EA-6 are implemented. All three keeps expose distinct plans and a complete commander-to-geometry matrix, and the latest 1280×720 board-first Preparation gate is closed. Human validation and owner distribution approval remain pending.
