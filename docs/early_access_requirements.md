...
**Current baseline:** `0.70.0-combat-cadence`; GPT56, investment, Early Access, P81 clarity, and P82 cadence gates are machine-checked. The six-tick simulation remains unchanged while normal-speed Assault gains readable timing and presentation-only contact spacing. The progress ledgers record exact evidence, automated candidate status, and the owner-controlled distribution boundary.
