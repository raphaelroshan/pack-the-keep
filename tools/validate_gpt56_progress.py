...
PACKET_REQUIREMENTS = {
    "PTK-GPT56-1": {"greywatch_normal_flow", "two_seeded_openings", "visible_plan_rationale", "preparation_first_viewport", "war_council_first_viewport", "deterministic_three_wave_replay", "all_phase_save_resume", "accessible_input_motion", "greywatch_1600_capture", "authoritative_state"},
