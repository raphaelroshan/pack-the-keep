...
BOARD_FIRST_CAPTURES = [
    ("docs/visual_evidence/v0.65.0-preparation-first-viewport-greywatch-1280x720/capture-manifest.json", "gatehouse_lock", {"width": 1280, "height": 720}, False),
    ("docs/visual_evidence/v0.65.0-preparation-first-viewport-ash-ford-1280x720/capture-manifest.json", "ash_ford_crossing", {"width": 1280, "height": 720}, False),
    ("docs/visual_evidence/v0.65.0-preparation-first-viewport-ash-ford-1600x900/capture-manifest.json", "ash_ford_crossing", {"width": 1600, "height": 900}, False),
]
